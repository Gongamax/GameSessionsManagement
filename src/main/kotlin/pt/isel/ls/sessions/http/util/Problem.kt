...
class Problem (
    ...
    private fun toResponse() = Response(status)
    ...
    companion object {
        ...
        fun missingParameters(instance: URI?) = Problem(
        ...
        fun nameAlreadyExists(instance: URI?) = Problem(
        ...
        fun gameNotFound(instance: URI?) = Problem(
