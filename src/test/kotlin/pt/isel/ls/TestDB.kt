...
//        // Insert new course
//        dataSource.connection.use {
//            val stm = it.prepareStatement("insert into courses(name) values ('$DUMMY_COURSE_NAME')")
//            val rs = stm.executeUpdate()
//            assertEquals(1, rs)
//        }
//
...
//        dataSource.connection.use {
//            val stm = it.prepareStatement("select * from courses where name = '$DUMMY_COURSE_NAME'")
//            val rs = stm.executeQuery()
//            assert(rs.next())
//            cid = rs.getInt("cid")
//        }
...
//        // Insert new student
//        dataSource.connection.use {
//            val stm = it.prepareStatement("insert into students values ($studentNumber,'$DUMMY_STUDENT_NAME', $cid)")
//            val rs = stm.executeUpdate()
//            assertEquals(1, rs)
//        }
//
...
//        dataSource.connection.use {
//            val stm =
//                it.prepareStatement("update students set name = '$DUMMY_STUDENT_NEW_NAME' where number = $studentNumber and course = $cid")
//            val rs = stm.executeUpdate()
//            assertEquals(1, rs)
//        }
//
...
//        }
//        dataSource.connection.use {
//            val stm = it.prepareStatement("delete from courses where name = '$DUMMY_COURSE_NAME'")
//            val rs = stm.executeUpdate()
//            assertEquals(1, rs)
//        }
//    }
...
//
//        private const val DUMMY_STUDENT_NAME = "Maria"
//        private const val DUMMY_COURSE_NAME = "LEIM"
//        private const val DUMMY_STUDENT_NEW_NAME = "Mariana"
//    }
}
